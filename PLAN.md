...
**Status:** Phases 1-8C complete, 7D partial, 11B+11D complete. 11C deferred. Remaining: 11A. Phases 9+ require infrastructure.
...
- [x] **curl install script** — `install.sh` at repo root; detects OS/arch; downloads from releases; `INSTALL_DIR` override supported
